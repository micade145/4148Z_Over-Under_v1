...
void defenseAuto(defense_auto_mode s) {
	...
	setCurve(10, 70, 20, 100, 100, 2000);
	...
	setMove(30, 90, 90, 70, 1200, false, false);
	pros::delay(200);
	...
	setMove(-60, 40, 100, 90, 2000, false, false);
	waitUntilSettled(20);
