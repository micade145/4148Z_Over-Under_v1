...
void BADtestProg() { // why is it so bad
	// init
	...
	shakeRobot();
	setMoveToPoint(46, 10, 80, 120, 1000);
	pros::delay(800);
	setMoveToPoint(106, 10, 1900);
	waitUntilSettled(0);

	// **** Push triball in from side of goal **** //
	setMove(50, 0, 128, 75, 1800);
	pros::delay(400);
	states.setWingState(stateMachine::wing_state::RIGHT_OUT);
	waitUntilSettled(0);
	setMove(-6, 0, 128, 80, 800, true);
	pros::delay(800);
	setMove(18, 0, 128, 80, 1000);
	pros::delay(1000);
	states.setWingState(stateMachine::wing_state::WINGS_STOWED);
	setMove(-8, 0, 128, 80, 1000);
	waitUntilSettled(0);

	// **** Score triballs from middle of field **** //
	// setMoveToPoint(96, 36, 1000);
	setMove(0, 275, 900);
	pros::delay(900);
	setMove(120, 89, 128, 65, 2000);
	pros::delay(500);
	...
	pros::delay(800);
	setMove(-32, 90, 128, 100, 1400);
	pros::delay(200);
	states.setWingState(stateMachine::wing_state::WINGS_STOWED);
	waitUntilSettled(0);
	setMoveToPoint(84, 108, 1600);
	pros::delay(1600);
	setMove(0, 145, 0, 100, 800);
	pros::delay(600);
	states.setWingState(stateMachine::wing_state::WINGS_OUT);
	setMove(72, 110, 128, 80, 1500);
}
...
void testProg() { // pushes with back of robot
	...
	waitUntilSettled(0);
	setMove(-40, 190, 127, 65, 1800);
	pros::delay(1800);
	// setMove(6, 180, 127, 100, 1000);
	// waitUntilSettled(0);
	...
	setMove(-12, 180, 128, 80, 1000, true);
	pros::delay(1000);
	setMove(9, 200, 128, 80, 1000);
	waitUntilNear(3, 0);
	// push 2
	setMove(0, 180, 800);
	pros::delay(500);
	setMove(-12, 180, 128, 128, 1000, true);
	pros::delay(1000);
	setMove(4, 200, 128, 80, 1000);
	waitUntilNear(3, 0);
	
	// **** Score triballs from middle of field **** //
	setMoveToPoint(84, 36, 1500);
	waitUntilNear(4, 0);
	...
	setMoveToPoint(84, 108, 1600);
	pros::delay(1600);
	setMove(0, 140, 0, 100, 800);
	pros::delay(600);
	states.setWingState(stateMachine::wing_state::WINGS_OUT);
	setMove(72, 100, 128, 80, 1500);
}
...
void defenseAuto(defense_auto_mode s) {
	...
	if(s == defense_auto_mode::SOLO){
		setMove(-18, 345, 100, 80, 1000); //angle 335
		waitUntilSettled(20);
		setMove(0, 75, 0, 80, 1000);
		pros::delay(800); //800
		...
		setMove(-43, 67, 90, 40, 2300); // move -48, turn 70
		waitUntilSettled(0);
		...
		states.setWingState(stateMachine::wing_state::RIGHT_OUT);
		pros::delay(100);
		setMove(15, 140, 110, 80, 1000);	// we want this to timeout before reaching target
		pros::delay(1000);
...
void defense3Ball() {
	...
	// setMove(64, 16, 90, 63, 2300);
	// 	// setMove(48, 15, 100, 70, 1300);
	// pros::delay(2000);
	// // setMoveToPoint(leftTriball1.x , leftTriball1.y - 10, 0, 90, 100, 0, 1300);
	// // setMove(48, 15, 80, 100, 1300);
	// // pros::delay(1200);
	// states.setIntakeState(stateMachine::intake_state::INTAKING);
	// pros::delay(300);
	// waitUntilSettled(0);
	// setMove(-24, 330, 100, 100, 1400);
	// waitUntilSettled(0);
	// setMove(0, 95, 0, 100, 1000);
	// waitUntilSettled(0);
	// pros::delay(400);
	// states.setPuncherAngleState(stateMachine::puncher_angle_state::FLAT);
	// pros::delay(500);
...
void sixBall() {
	...
	states.setIntakeState(stateMachine::intake_state::OPEN);
	// pros::delay(480);
	setMoveToPoint(rightTriball3.x + 13, rightTriball3.y - 8, 119, 128, 1500);
	...
	setMoveToPoint(rightTriball5.x + 11, rightTriball5.y, 1200); //rightTriball5.y + 0
	waitUntilSettled(0);
	states.setIntakeState(stateMachine::intake_state::CLOSED);
	...
	setMove(0, 70, 900);
	waitUntilSettled(0);
	setMoveToPoint(119, 58, 128, 100, 1300);
	states.setIntakeState(stateMachine::intake_state::OPEN);
	waitUntilSettled(0);
...
void fourBall() {
	...
	setMove(0, 315, 0, 100, 800);
	// setMoveToPoint(rightTriball3.x, rightTriball3.y, 0, 0, 100, 0, 800);
	waitUntilSettled(0);

	// 2 triballs from mid
	setMove(22, 315, 100, 80, 1300);
	pros::delay(1100);
	states.setIntakeState(stateMachine::intake_state::CLOSED);
	pros::delay(100);
	waitUntilSettled(0);

	setMove(-10, 315, 100, 80, 1300);
	waitUntilSettled(0);
	setMove(0, 92, 0, 100, 800);
	waitUntilSettled(20);
	setMove(27, 92, 100, 80, 1000);
	states.setWingState(stateMachine::wing_state::WINGS_OUT);
	pros::delay(200);
	states.setIntakeState(stateMachine::intake_state::OPEN);
